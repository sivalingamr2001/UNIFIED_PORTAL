...
export const BankMasterPage: React.FC = () => {
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2 text-xs text-slate-500 font-medium">
          <span className="font-semibold text-slate-700">Bank Master</span>
      ...
      <main className="flex-1 overflow-y-auto p-5 bg-[#f0f4f8]" style={{ scrollbarWidth: 'thin' }}>
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm max-w-md">
          <h1 className="text-sm font-bold text-slate-900 mb-2">Bank Master</h1>
